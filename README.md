...
2. Use the following internal URL for synchronization:
    ...
    *Note: Replace `<repo-hash>` with the 8-character hash generated by Home Assistant for your custom repository (e.g., `385dfded-awaria-outage-monitor`). If you installed the add-on locally (not from a repository), use `local-awaria-outage-monitor`.*
