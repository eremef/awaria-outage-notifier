...
const translations = {
    en: {
        ...
        "source_psg": "🔥 Gas Outage (PSG)",
        "source_wmk": "💧 Water Outage (WMK)",
        "source_tauron_heat": "🔥 Heat Outage (Tauron)",
        "source_veolia": "🔥 Heat Outage (Veolia Warszawa)",
        "source_veolia_poznan": "🔥 Heat Outage (Veolia Poznań)",
        "source_aquanet": "💧 Water Outage (Aquanet)",
        "source_katowickie_wodociagi": "💧 Water Outage (Kat. Wodociągi)",
        "lbl_section_tauron_heat": "Heat (Tauron)",
        "lbl_section_tauron": "Power (Tauron)",
        "lbl_section_mpwik_wroclaw": "Water (MPWiK)",
        ...
        "lbl_section_katowickie_wodociagi": "Water (Kat. Wodociągi)",
        ...
        "source_veolia_name": "Veolia Warszawa",
        "source_veolia_poznan_name": "Veolia Poznań",
        "source_katowickie_wodociagi_name": "Kat. Wodociągi",
        "source_tauron_short": "Tauron",
        "source_mpwik_wroclaw_name": "MPWiK Wrocław",
        "source_mpwik_wroclaw_short": "MPWiK",
        "source_mpwik_warszawa_name": "MPWiK Warszawa",
        "source_mpwik_warszawa_short": "MPWiK WA",
        ...
        "source_veolia_short": "Veolia Warszawa",
    ...
    pl: {
        ...
        "source_psg": "🔥 Wyłączenie gazu (PSG)",
        "source_wmk": "💧 Wyłączenie wody (WMK)",
        "source_aquanet": "💧 Awaria wody (Aquanet)",
        "source_tauron_heat": "🔥 Wyłączenie ciepła (Tauron)",
        "source_veolia": "🔥 Wyłączenie ciepła (Veolia Warszawa)",
        "source_veolia_poznan": "🔥 Wyłączenie ciepła (Veolia Poznań)",
        "source_katowickie_wodociagi": "💧 Awaria wody (Kat. Wodociągi)",
        "lbl_section_tauron_heat": "Ciepło (Tauron)",
        "lbl_section_tauron": "Prąd (Tauron)",
        "lbl_section_mpwik_wroclaw": "Woda (MPWiK)",
        ...
        "lbl_section_katowickie_wodociagi": "Woda (Kat. Wodociągi)",
